...
from strategies import Extort1_6_independent
...
def game_CIC_vs_CIC():
    f = open("data/CIC_vs_Extort1_6_independent_realtime_payoff_error=0.1SI.csv", 'a', newline='')
    writer = csv.writer(f)
    ...
    for i in range(times):
        print(i)
        player1 = CIC.CIC()
        player2 = Extort1_6_independent.Extort1_6_independent()
        ...
        for j in range(step):
            ...
            sum_player2_channel1_reward += player2.Extort1_6_independent_reward1(decision_player2_current, decision_player1_current)
            sum_player2_channel2_reward += player2.Extort1_6_independent_reward2(decision_player2_current, decision_player1_current)
            ...
            decision_player2_next = player2.Extort1_6_independent_desicion(decision_player2_current,decision_player1_current)
