...
from strategies import Extort1_2_independent
...
def game_WSLS_vs_WSLS():
    f = open("data/WSLS_vs_Extort1_2_independent_realtime_payoff_error=0.1SI.csv", 'a', newline='')
    writer = csv.writer(f)
    ...
    for i in range(times):
        print(i)
        player1 = WSLS.WSLS()
        player2 = Extort1_2_independent.Extort1_2_independent()
        ...
        for j in range(step):
            ...
            sum_player2_channel1_reward += player2.Extort1_2_independent_reward1(decision_player2_current, decision_player1_current)
            sum_player2_channel2_reward += player2.Extort1_2_independent_reward2(decision_player2_current, decision_player1_current)
            ...
            decision_player2_next = player2.Extort1_2_independent_desicion(decision_player2_current,decision_player1_current)
