...
def game_ALLC_vs_ALLC():
    ...
    for i in range(times):
        ...
        for j in range(step):
            ...
            sum_player1_channel1_reward += player1.ALLC_reward1(decision_player1_current, decision_player2_current)
            sum_player1_channel2_reward += player1.ALLC_reward2(decision_player1_current, decision_player2_current)
            ...
            decision_player1_next = player1.ALLC_desicion(decision_player1_current,decision_player2_current)
