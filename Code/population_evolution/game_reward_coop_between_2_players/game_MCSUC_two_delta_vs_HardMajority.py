...
import sys
sys.path.append("..")
from strategies import HardMajority
...
def game_MCSUC_vs_HardMajority():
    step = 1000000
    times = 1000
    epsilon = 0.1
    ...
    for i in range(times):
        ...
        player2 = HardMajority.HardMajority()
        ...
        for j in range(step):
            ...
            sum_player2_channel1_reward += player2.HardMajority_reward1(decision_player2_current, decision_player1_current)
            sum_player2_channel2_reward += player2.HardMajority_reward2(decision_player2_current, decision_player1_current)

            player2.HardMajority_opp_decision_store(decision_player1_current)

            decision_player1_next = player1.MCSUC_desicion(decision_player1_current,decision_player2_current)
            decision_player2_next = player2.HardMajority_desicion()
    ...
    print('avg_reward_player1:%.6f' % (avg_all_time_player1_reward1+avg_all_time_player1_reward2)+'\n''avg_reward_player2:%.6f'%(avg_all_time_player2_reward1+avg_all_time_player2_reward2))
    ...
    print('avg_coo_player1:%.6f'%((avg_all_time_player1_coo1+avg_all_time_player1_coo2)/2)+
          '\n'+'avg_coo_player2:%.6f'%((avg_all_time_player2_coo1+avg_all_time_player2_coo2)/2))

    print((avg_all_time_player1_coo1+avg_all_time_player1_coo2+avg_all_time_player2_coo1+avg_all_time_player2_coo2)/4.0)


if __name__== "__main__" :
    game_MCSUC_vs_HardMajority()