...
def game_MCSUC_vs_ALLD():
    ...
    for i in range(times):
        ...
        for j in range(step):
            ...
            sum_player2_channel1_reward += player2.ALLD_reward1(decision_player2_current, decision_player1_current)
            sum_player2_channel2_reward += player2.ALLD_reward2(decision_player2_current, decision_player1_current)

            decision_player1_next = player1.MCSUC_desicion(decision_player1_current,decision_player2_current)
            decision_player2_next = player2.ALLD_desicion(decision_player2_current,decision_player1_current)
