...
def game_MCSUC_vs_MCSUC(epsilon):
    step = 1000000
    times = 1000
    epsilon = epsilon
    ...
    for i in range(times):
        ...
        player2 = MCSUC_two_delta.MCSUC_two_delta()
        ...
        for j in range(step):
            ...
            sum_player2_channel1_reward += player2.MCSUC_reward1(decision_player2_current, decision_player1_current)
            sum_player2_channel2_reward += player2.MCSUC_reward2(decision_player2_current, decision_player1_current)

            decision_player1_next = player1.MCSUC_desicion(decision_player1_current,decision_player2_current)
            decision_player2_next = player2.MCSUC_desicion(decision_player2_current,decision_player1_current)
