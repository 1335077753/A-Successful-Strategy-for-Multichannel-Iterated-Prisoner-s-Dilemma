...
def game_MCSUC_vs_Generous_independent(epsilon):
    step = 1000000
    times = 1000
    epsilon = epsilon
    ...
    for i in range(times):
        ...
        for j in range(step):
            ...
            visit_d_times(visit, player1.i, player1.j)
    ...
    print('avg_reward_player1:'+str(avg_all_time_player1_reward1+avg_all_time_player1_reward2)+'\n''avg_reward_player2:'+str(avg_all_time_player2_reward1+avg_all_time_player2_reward2))
    # make picture model
    print(
    ...
    print('avg_coo_player1:'+str((avg_all_time_player1_coo1+avg_all_time_player1_coo2)/2)+
          '\n'+'avg_coo_player2:'+str((avg_all_time_player2_coo1+avg_all_time_player2_coo2)/2))
...
if __name__== "__main__" :
    ...
    for epsilon in epsilons:
        game_MCSUC_vs_Generous_independent(epsilon)