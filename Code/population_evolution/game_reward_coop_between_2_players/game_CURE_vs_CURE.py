...
def game_CURE_vs_CURE():
    ...
    for i in range(times):
        player1 = CURE_multi_channel_version.CURE()
        ...
        for j in range(step):
            ...
            sum_player1_channel1_reward += player1.CURE_reward1(decision_player1_current, decision_player2_current)
            sum_player1_channel2_reward += player1.CURE_reward2(decision_player1_current, decision_player2_current)
            ...
            decision_player1_next = player1.CURE_desicion(decision_player1_current,decision_player2_current)
