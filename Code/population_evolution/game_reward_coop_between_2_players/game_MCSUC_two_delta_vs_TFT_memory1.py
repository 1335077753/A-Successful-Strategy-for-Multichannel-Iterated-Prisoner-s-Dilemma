...
import sys
sys.path.append("..")
from strategies import TFT_memory_1
...
def game_MCSUC_vs_TFT_memory_1(epsilon):
    step = 1000000
    times = 1000
    epsilon = epsilon
    ...
    for i in range(times):
        ...
        for j in range(step):
            ...
            sum_player2_channel1_reward += player2.TFT_reward1(decision_player2_current, decision_player1_current)
            sum_player2_channel2_reward += player2.TFT_reward2(decision_player2_current, decision_player1_current)

            decision_player1_next = player1.MCSUC_desicion(decision_player1_current,decision_player2_current)
            decision_player2_next = player2.TFT_desicion(decision_player2_current,decision_player1_current)
...
if __name__== "__main__" :
    ...
    for epsilon in epsilons:
        game_MCSUC_vs_TFT_memory_1(epsilon)