...
def game_TFT_vs_TFT(epsilon):
    ...
    for i in range(times):
        ...
        for j in range(step):
            ...
            sum_player1_channel1_reward += player1.TFT_reward1(decision_player1_current, decision_player2_current)
            sum_player1_channel2_reward += player1.TFT_reward2(decision_player1_current, decision_player2_current)
            ...
            decision_player1_next = player1.TFT_desicion(decision_player1_current,decision_player2_current)
