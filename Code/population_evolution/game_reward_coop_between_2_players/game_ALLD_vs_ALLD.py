...
def game_ALLD_vs_ALLD():
    ...
    for i in range(times):
        ...
        for j in range(step):
            ...
            sum_player1_channel1_reward += player1.ALLD_reward1(decision_player1_current, decision_player2_current)
            sum_player1_channel2_reward += player1.ALLD_reward2(decision_player1_current, decision_player2_current)
            ...
            decision_player1_next = player1.ALLD_desicion(decision_player1_current,decision_player2_current)
