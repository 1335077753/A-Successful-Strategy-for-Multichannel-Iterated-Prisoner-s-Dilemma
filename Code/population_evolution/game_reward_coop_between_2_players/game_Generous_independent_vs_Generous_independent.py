...
import sys
sys.path.append("..")
from strategies import Generous_independent
from strategies import Generous_independent
...
def game_Generous_independent_vs_Generous_independent():
    step = 1000000
    times = 1000
    epsilon = 0.1
    ...
    for i in range(times):
        print(i)
        player1 = Generous_independent.Generous_independent()
        player2 = Generous_independent.Generous_independent()
        ...
        for j in range(step):
            ...
            sum_player1_channel1_reward += player1.Generous_independent_reward1(decision_player1_current, decision_player2_current)
            sum_player1_channel2_reward += player1.Generous_independent_reward2(decision_player1_current, decision_player2_current)
            sum_player2_channel1_reward += player2.Generous_independent_reward1(decision_player2_current, decision_player1_current)
            sum_player2_channel2_reward += player2.Generous_independent_reward2(decision_player2_current, decision_player1_current)

            decision_player1_next = player1.Generous_independent_desicion(decision_player1_current,decision_player2_current)
            decision_player2_next = player2.Generous_independent_desicion(decision_player2_current,decision_player1_current)
...
if __name__== "__main__" :
    game_Generous_independent_vs_Generous_independent()